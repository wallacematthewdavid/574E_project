...
plot(predict(coco_wf_nat_lg.kppm))
...
plot(predict(coco_wf_nat_sm.kppm))
...
plot_envelopes <- function(naive.kppm, model.kppm){
  ...
  plot(envelope(naive.kppm, fun = Kest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
  plot(envelope(model.kppm, fun = Fest),
...
```{r}
plot_envelopes(coco_wf_hum_naive.kppm, coco_wf_hum.kppm)
```

# Threshold

```{r}
plot_envelopes(coco_wf_hum_lg_naive.kppm, coco_wf_hum_lg.kppm)
plot_envelopes(coco_wf_hum_sm_naive.kppm, coco_wf_hum_sm.kppm)
```
...
```{r}
plot_envelopes(coco_wf_nat_naive.kppm, coco_wf_nat.kppm)
```

# Threshold

```{r}
plot_envelopes(coco_wf_nat_lg_naive.kppm, coco_wf_nat_lg.kppm)
plot_envelopes(coco_wf_nat_sm_naive.kppm, coco_wf_nat_sm.kppm)
```


```{r}
wf_naive.kppm <- kppm(unmark(coco_wf_hum.ppp)~1, clusters = "LGCP", model = "exponential")

plot(envelope(wf_naive.kppm, fun = Fest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum.kppm, fun = Fest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)

plot(envelope(wf_naive.kppm, fun = Gest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum.kppm, fun = Gest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)

plot(envelope(wf_naive.kppm, fun = Kest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum.kppm, fun = Kest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
```
...
```{r}
wf_naive.kppm <- kppm(unmark(coco_wf_hum_lg.ppp)~1, clusters = "LGCP", model = "exponential")

plot(envelope(wf_naive.kppm, fun = Fest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum_lg.kppm, fun = Fest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Gest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum_lg.kppm, fun = Gest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Kest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_hum_lg.kppm, fun = Kest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
```
...
```{r}
wf_naive.kppm <- kppm(unmark(coco_wf_nat.ppp)~1, clusters = "LGCP", model = "exponential")

plot(envelope(wf_naive.kppm, fun = Fest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat.kppm, fun = Fest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Gest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat.kppm, fun = Gest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Kest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat.kppm, fun = Kest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
```
...
```{r}
wf_naive.kppm <- kppm(unmark(coco_wf_nat_lg.ppp)~1, clusters = "LGCP", model = "exponential")

plot(envelope(wf_naive.kppm, fun = Fest),
     col = c("black","darkgreen", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat_lg.kppm, fun = Fest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Gest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat_lg.kppm, fun = Gest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
...
plot(envelope(wf_naive.kppm, fun = Kest),
     ...
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, legend = F, main = "Envelopes")
plot(envelope(coco_wf_nat_lg.kppm, fun = Kest),
     col = c(NA, "darkred", NA, NA),
     shadecol = adjustcolor("gray", 0.5),
     lwd = 2, add = T)
```